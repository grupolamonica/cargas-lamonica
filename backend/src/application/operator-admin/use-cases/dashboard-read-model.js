  ...
  return withPgClient(async (client) => {
    ...
    const fullSelectSql = (whereSql) => `
      SELECT
        ...
        clientes.observacoes AS cliente_observacoes, clientes.tipo_veiculo AS cliente_tipo_veiculo,
        clientes.peso AS cliente_peso, clientes.exige_antt AS cliente_exige_antt,
      ...
      payload: {
        items: itemRows.map((row) => ({
          ...
          cliente: row.cliente_id ? {
            ...
            observacoes: row.cliente_observacoes, tipo_veiculo: row.cliente_tipo_veiculo,
            peso: row.cliente_peso, exige_antt: row.cliente_exige_antt,
