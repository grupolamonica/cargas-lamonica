        ...
        try {
          const allocRows = await selectAllPaginated(
            (from, to) =>
              supabaseClient
                .from("cargas")
                .select("sheet_lh, alloc_motorista, alloc_cavalo, alloc_carreta, alloc_status, alloc_tipo, alloc_descricao, alloc_vinculo, alloc_tratativas, alloc_checklist_cavalo, alloc_checklist_carreta, alloc_pinned, alloc_updated_at")
        ...
        try {
          const systemAllocRows = await selectAllPaginated(
            (from, to) =>
              supabaseClient
                .from("cargas")
                .select("lh_manual, alloc_motorista, alloc_cavalo, alloc_carreta, alloc_status, alloc_tipo, alloc_descricao, alloc_vinculo, alloc_tratativas, alloc_checklist_cavalo, alloc_checklist_carreta, alloc_pinned, alloc_updated_at")
                .is("sheet_lh", null)
