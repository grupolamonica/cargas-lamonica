...
import {
  resolveOperatorAutoApproveAngelliraGetResponse,
  resolveOperatorAutoApproveAngelliraPutResponse,
...
export function registerRoutes(app) {
  ...
  router.patch("/api/operator/sheet-monitor/reserva", wrap(resolveUpdateReservaResponse));
  ...
  router.get("/api/operator/vehicle-checklist/levels", wrap(resolveVehicleChecklistLevelsResponse));
