...
import { withPgClient, withPgTransaction } from "../../lib/postgres.js";
import { insertSecurityAuditEvent } from "../../lib/security-audit.js";
import { logStructuredEvent } from "../../lib/security-log.js";
import { getPostgresTlsConfiguration, isEnabledEnv } from "../../lib/postgres-ssl.js";
import { getDriverValidationMetricsSnapshot } from "../driver-validation/metrics.js";
import {
  ConflictError,
  ForbiddenError,
  NotFoundError,
  ValidationError,
} from "../load-claims/errors.js";
import { getRouteInfo } from "../geoapify/index.js";
import { parseDriverLoadsQuery, parseOperatorDashboardQuery } from "./schemas.js";
import {
  buildPaginationMeta,
  parseNullableNumber,
