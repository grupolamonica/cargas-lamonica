    ...
    <div className="space-y-4 rounded-2xl bg-white p-4 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
      ...
      {items.map((item) => (
        <Link
          ...
          className="block rounded-xl bg-gray-50 p-4 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        >
          ...
          <div className="mt-2 flex items-center justify-between gap-2">
            ...
            <span className="text-sm font-semibold text-[hsl(224_94%_37%)]">
              Ver detalhes
            </span>
          </div>
        </Link>
